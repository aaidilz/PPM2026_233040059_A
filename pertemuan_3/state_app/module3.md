...
- [x] Saat pertama buka, ada 1 catatan dummy "Belajar Flutter"
- [x] Tap FAB **Tambah** → halaman form muncul
- [x] Tekan **Simpan** dengan field kosong → muncul pesan error merah
- [x] Isi judul kurang dari 3 karakter → muncul "Minimal 3 karakter"
- [x] Isi semua field dengan benar → tekan **Simpan** → kembali ke Home, list bertambah, muncul SnackBar
- [x] Tap salah satu item → halaman Detail muncul dengan data benar
- [x] Tekan back / tombol "Kembali ke Daftar" → balik ke Home
- [x] Tap ikon hapus di salah satu item → item hilang
- [x] Hapus semua → muncul empty state "Belum ada catatan"
